...
var fsbasic = __importStar(require("fs"));
var googleapis_1 = require("googleapis");
var readline_1 = __importDefault(require("readline"));
var fs = fsbasic.promises;
var SCOPES = [
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4, fs.readFile('config/credentials.json')];
                case 1:
                    content = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            rl.question('Enter the code from that page here: ', function (code) {
                rl.close();
                client.getToken(code, function (err, token) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (err)
                                    return [2, console.error('Error retrieving access token', err)];
                                return [4, fs.writeFile(TOKEN_PATH, JSON.stringify(token))];
                            case 1:
                                _a.sent();
                                return [2];
                        }
